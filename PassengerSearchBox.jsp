...
<h4 class="mb-3">redBuz Passenger Management</h4>

   <form action="displayall" style="border:1px solid #ccc" > 
    <div class="container">
     <div class="note"><p >Please fill in this form to create add the bus.</p></div>
 <div class="col-md-6 mb-3">
   <label ><b >Bus No : </strong></label><br>
  
   <input  type="number" name="busno" placeholder="Enter Your Bus No"  class="form-control"   required>
</div>
 ...
 <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" style="background-color:#B22222;" type="submit">Passenger Details Request</button>   </div>
</form>
</div>
