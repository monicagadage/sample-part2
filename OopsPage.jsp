...
<link href="OopsPage1.css" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="OopsPage2.css">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    ...
    <div class="fl clearfix" id="page_main_header">
        <nav class="product-nav fl">
            <ul>
                             <li><a href="http://localhost:8077/BusReservationTest/RedBusHomePage.jsp" title="redBus" class="selectedBus site-links"><style>.rest .promotions-wrap{margin-left:44px;margin-top:-96px;}</style>BUS TICKETS </a></li>
   ...
   <div class="colo" style="padding-left: 451px;padding-right: 101px;">
    <div><img src="no_bus.png" alt="Mountain View"></div>
    
    </div>
    <div class="colo" style="padding-left: 551px;padding-right: 101px;">
    <h3>OOPS!!! NO BUS FOUND</h3>
    </div>
