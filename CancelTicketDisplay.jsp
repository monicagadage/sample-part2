...
<title>Cancel Ticket Display</title>
        ...
        <nav class="product-nav fl">
            <ul>
                            ...
                            <!-- <li><a href="https://www.redbus.in/bushire/?utm_source=website&amp;utm_medium=referral&amp;utm_campaign=Homepage_bushire_banner" title="redBus Bus Hire" class="site-links gtm-busHire">BOOK NOW </a></li> -->
                             ...
                             <li><a href="http://localhost:8077/BusReservationTest/CancelTicket.jsp" title="pilgrimages" class="selectedBus site-links">CANCEL TICKET </a></li>
...
<h4 class="mb-3">Ticket Details</h4>
  ...
  <form   class="needs-validation" action="Confirm.htm" style="border:1px solid #ccc" >
  
    <div class="container">
     <div class="note"><p >Kindly check your ticket details.</p></div>
  <div class="col-md-6 mb-3">
   <label for="empid"><b>Bus Name : </b></label><br>
  <label class="form-control"> redBuz Travels </label>
</div>
...
<label for="lnam"><b>Total Fare :</b></label><br>
  ...
  <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" style="background-color:#B22222;"  type="submit">Confirm Cancellation</button>   </div>
