...
<head>
<meta charset="utf-8">
<meta http-equiv="Refresh" content="4;url=http://localhost:8077/BusReservationTest/RedBusHomePage.jsp">
...
<button style="background:#B22222; color:#fff; height:40px; width:200px; border:none" class="alert">CANCELED SUCCESSFULLY  </button>
