    ...
    <div class="fl clearfix" id="page_main_header">
        <nav class="product-nav fl">
            <ul>
                            ...
                            <li><a href="http://localhost:8077/BusReservationTest/AddBus.jsp" title="redBus Hotels" class="selectedBus site-links gtm-hotels">BUS MANAGEMENT </a></li>
...
<h4 class="mb-3">redBuz Bus Management</h4>
  <form   class="needs-validation" action="addbus.htm" style="border:1px solid #ccc" >
    <div class="container">
     <div class="note"><p >Please fill in this form to create add the bus.</p></div>
 <div class="col-md-6 mb-3">
   <label ><b >Bus No : </strong></label><br>
  <input  type="number" name="busno" placeholder="Enter Your Bus No"  class="form-control"   value="" required pattern=[0-9]{4}>
</div>
...
<select name="bustype" class="custom-select d-block w-100" >
...
<label ><b>Deluxe </b></label>
<select name="ac" class="custom-select d-block w-100" >
  <option value="AC" selected>AC Bus </option>
 ...
 <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" style="background-color:#B22222;" type="submit">Add Bus</button>   </div>
</form>
</div>
